...
- Risks: the 1080p hero is 5.4 MB (desktop only, `preload=auto` after load); food WebPs ~100–200 KB at 1600 w (served 480/900 on phones via `sizes`). Fonts are self-hosted (Fontsource). No third-party scripts.
