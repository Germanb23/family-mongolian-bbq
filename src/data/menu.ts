...
export const menu: MenuCategory[] = [
  {
    ...
    name: 'Appetizers',
    items: [
      { code: 'A1', name: 'Barbecue Pork', description: 'Char siu — sweet-savory marinated pork, caramelized.', price: '12.97', portrait: 'bbq-pork', doordash: '20.99' },
  ...
  },
  {
    ...
    name: 'Vegetables',
    items: [
      { code: 'V1', name: 'Eggplant with Tofu', description: 'Eggplant and silky tofu in savory sauce.', price: '16.97', portrait: 'eggplant-tofu', doordash: '18.99', tags: ['spicy', 'vegetarian-friendly'] },
      ...
      { code: 'V5', name: 'Sautéed Garden Vegetables', description: 'Fresh seasonal vegetables, quickly stir-fried.', price: '16.97', portrait: 'garden-vegetables', doordash: '18.99', tags: ['vegetarian-friendly'] },
  ...
  },
  {
    ...
    items: [
      ...
      { code: 'C11', name: 'Kung Pao Chicken', description: 'Chicken, peanuts and vegetables in spicy sauce.', price: '18.97', portrait: 'kung-pao-chicken', photo: 'kung-pao-chicken', doordash: '20.99', tags: ['spicy'] },
      ...
      { code: 'C16', name: 'Sweet & Sour Chicken', description: 'Chicken in a vibrant sweet and tangy sauce.', price: '18.97', portrait: 'sweet-sour-chicken', doordash: '20.99' },
    ],
  },
  {
    id: 'beef',
    ...
    items: [
      ...
      { code: 'B3', name: 'Beef with Bell Pepper', description: 'Beef slices with vibrant bell peppers.', price: '19.97', portrait: 'beef-bell-pepper' },
      { code: 'B4', name: 'Beef with Mixed Vegetables', description: 'Beef with crisp, colorful vegetables.', price: '19.97', portrait: 'beef-mixed-vegetables', doordash: '21.99' },
  ...
  },
  {
    ...
    name: 'Pork',
    items: [
      { code: 'P1', name: 'BBQ Pork with Broccoli', description: 'Barbecue pork and broccoli in savory sauce.', price: '18.97', portrait: 'bbq-pork-broccoli', doordash: '20.99' },
      ...
      { code: 'P4', name: 'Pork in Hot Garlic Sauce', description: 'Pork strips in fiery garlic sauce.', price: '18.97', portrait: 'pork-hot-garlic', doordash: '20.99', tags: ['spicy'] },
  ...
  },
  {
    ...
    items: [
      ...
      { code: 'S6', name: 'Cashew Shrimp', description: 'Shrimp, crunchy cashews and vegetables in savory sauce.', price: '22.97', portrait: 'cashew-shrimp' },
  ...
  },
  {
    ...
    items: [
      ...
      { code: 'EF2', name: 'Chicken Egg Foo Young', price: '18.97', portrait: 'chicken-egg-foo-young', doordash: '21.99' },
  ...
  },
  {
    ...
    items: [
      ...
      { code: 'SO2', name: 'Egg Flower Soup', description: 'Velvety broth with wisps of beaten egg.', price: '10.97', portrait: 'egg-flower-soup' },
      { code: 'SO3', name: 'Hot and Sour Soup', description: 'Tangy, spicy broth with mushrooms, tofu and bamboo shoots.', price: '10.97', portrait: 'hot-sour-soup', tags: ['spicy'] },
      { code: 'SO4', name: 'Vegetable and Tofu Combination Soup', description: 'Light broth with fresh vegetables and silky tofu.', price: '10.97', portrait: 'vegetable-tofu-soup-2', tags: ['vegetarian-friendly'] },
      { code: 'SO5', name: 'Wor Wonton Soup', description: 'House wonton soup.', price: '11.97', portrait: 'wor-wonton-soup', doordash: '9.97' },
    ],
  },
  {
    id: 'rice-noodles',
    name: 'Rice & Noodles',
    items: [
      { code: 'RN1', name: 'House Special Fried Rice', description: 'Shrimp, chicken and Chinese sausage with egg and vegetables.', price: '16.77', portrait: 'house-fried-rice' },
      ...
      { code: 'RN3', name: 'House Special Chow Mein', description: 'Egg noodles with shrimp, chicken and vegetables.', price: '16.77', portrait: 'house-chow-mein' },
      { code: 'RN4', name: 'House Special Chow Fun', description: 'Wide rice noodles with shrimp, chicken and vegetables.', price: '16.77', portrait: 'house-chow-fun' },
      { code: 'RN5', name: 'House Special Mei Fun', description: 'Rice vermicelli with shrimp, chicken and vegetables.', price: '16.77', portrait: 'house-special-mei-fun', doordash: '16.77' },
